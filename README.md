...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/jawaher-hub/Medad-Frontend.git](https://github.com/jawaher-hub/Medad-Frontend.git)
    ```
